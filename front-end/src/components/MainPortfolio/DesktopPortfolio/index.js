...
export class DesktopPortfolio extends PureComponent {
  constructor(props) {
    super(props);
    autoBind(this);
  ...
  render() {
    ...
    return (
      <div className="portfolios-wrapper-desktop" ref={this.portfolios}>
...
export default connect(mapToStateProps, mapToDispatchProps)(DesktopPortfolio);
